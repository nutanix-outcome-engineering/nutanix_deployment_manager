...
function hydrateForm() {
  ...
  if(props.site) {
    form.site = {
      ...
      pcServers: [...props.site.pcServers],
      vCenterServers: [...props.site.vCenterServers]
    }
  }
  return form
}
  ...
  <Dialog v-model="isVisible" :heading="site ? 'Edit Site' : 'Add Site'">
    ...
    <form class="">
      <div class="flex flex-1 flex-col">
        <label for="name" class="pt-2 pb-2 text-sm font-medium leading-6 text-gray-700">Site Name</label>
        <input type="text" id="name" class="pt-2 pb-2 text-sm text-gray-700 focus:ring-blue-500 focus:border-blue-500 block w-full rounded-md sm:text-sm border-gray-300" v-model="form.site.name" placeholder="mySiteName" label="Name" v-on:keydown.enter.prevent/>
